                                    ...
                                    <tbody>
                                        @foreach ($data['guru'] as $guru)
                                            <tr>
                                                ...
                                                <td>{{ $guru->nohp }}</td>
                                                <td>
                                                    {{-- <a onclick="editData({{ $guru->id }})" href="javascript:void(0)"
                                                        class="text-primary" title="edit">
                                                        <i class="menu-icon tf-icons bx bx-pencil"></i>
                                                    </a> --}}
                                                    <a onclick="deleteData({{ $guru->id }})" href="javascript:void(0)"
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('guru.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <label for="kelas" class="form-label">NIP</label>
                            <div class="col-sm-12">
                        ...
                        <div class="row mb-3">
                            <label for="kelas" class="form-label">No Hp</label>
                            <div class="col-sm-12">
